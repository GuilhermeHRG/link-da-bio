// Refatoração do layout do Home.tsx
import { useEffect, useState } from 'react';
import profile from '../../assets/profile.jpg';
import {
  FaGithub, FaLinkedin, FaInstagram, FaWhatsapp, FaHtml5,
  FaReact, FaNodeJs, FaFigma, FaSearch, FaMobileAlt,
  FaBriefcase, FaBook
} from 'react-icons/fa';
import './home.css';
    ...
    <div className="home-container">
      ...
      <section className="section skills">
        ...
        <ul className="skill-list">
          ...
          <li><FaFigma /> UI/UX Design</li>
          <li><FaSearch /> SEO</li>
          <li><FaMobileAlt /> Sites Responsivos</li>
        </ul>
      </section>
      ...
      <section className="section-exp">
        ...
        <div className="card-exp">
          ...
          <div className="exp-content">
            ...
            <p>Trabalhei por 5 anos exercendo as funções de Office Boy, Arquivista de documentos e Auxiliar de Escritório.</p>
          </div>
        </div>
        ...
        <div className="card-exp">
          ...
          <div className="exp-content">
            ...
            <p>Atuei por 1 ano como Help Desk e atualmente sou Programador Frontend Jr.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section-exp">
        ...
        <div className="card-exp">
          ...
          <div className="exp-content">
            ...
            <p>Cursando 8° Semestre de Sistemas de Informação</p>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        © {new Date().getFullYear()} Guilherme Guelere - Elevando sua presença digital.
      </footer>
    </div>
  );
}
